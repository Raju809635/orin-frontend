...
const styles = StyleSheet.create({
  ...
  scopeHeading: { fontWeight: "900", fontSize: 14, marginTop: 4 },
  inlineLabel: { fontWeight: "800", fontSize: 12, marginTop: 2 },
  inlineSelect: { flex: 1, minWidth: 0, gap: 8 },
  scopeNote: { fontWeight: "700", lineHeight: 19 },
  textArea: { minHeight: 90, textAlignVertical: "top" },
  managerNotice: { borderWidth: 1, borderRadius: 14, padding: 10, gap: 8 },
  ...
  filterText: { fontWeight: "900", fontSize: 11 },
